...
- **:outbox_tray: Send HTTP Requests**: In addition to receiving HTTP requests, `wtt` can also send requests to arbitrary URLs and log the response. See [sending-requests.md](./src/docs/sending-requests.md).
